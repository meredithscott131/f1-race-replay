...
class CacheManager:
    ...
    def get_cache_info(self, year: int, round_number: int, session_type: str) -> Optional[Dict[str, Any]]:
        """
    ...
    def is_stale(self, year: int, round_number: int, session_type: str, max_age_days: int = 30) -> bool:
        """
